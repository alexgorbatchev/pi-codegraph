...
export class PiCodeGraphClient {
    ...
    async #start() {
        ...
        child.on("exit", (code) => peer.close(new Error(sanitizeDiagnostic(stderr) ||
    ...
    async request(method, params = {}, signal) {
        ...
        if (!peer)
            throw new Error("pi-codegraph MCP facade did not start");
...
//# sourceMappingURL=pi-mcp-client.js.map